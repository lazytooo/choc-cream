...
(function(window) {
	...
	var chocCreamCard = function(option, undefined) {
		return new chocCreamCard.fn.init(option, undefined);
	};
	chocCreamCard.prototype = chocCreamCard.fn = {
		constructor: chocCreamCard,
		...
		close: function(closecallback) {
			if (!this._closed) {
				...
				console.warn("chocCreamCard closed.");
				return;
			}
		...
		open: function(opencallback) {
			if (this._closed) {
				...
				console.warn("chocCreamCard opened.");
				return;
			}
			let GCard = this._GCard;
			let cardBox = GCard.querySelectorAll(".myuki-gcard_box")[0];
	...
	chocCreamCard.fn.init.prototype = chocCreamCard.fn;
	window.chocCreamCard = chocCreamCard;
	window.$MGC = chocCreamCard;
	return this;
})(window);
